...
import { createWindowOpenHandler, installGlobalWindowOpenPolicy } from './window-open-policy'
...
// Install before any BrowserWindow is created. This global seam protects
// hidden and auxiliary windows that do not pass through common window wiring.
...
function wireCommonWindowHandlers(win, { zoom = true }: { zoom?: boolean } = {}) {
  ...
  win.webContents.setWindowOpenHandler(
    createWindowOpenHandler(() => rememberLog('[window-open] denied'))
  )
